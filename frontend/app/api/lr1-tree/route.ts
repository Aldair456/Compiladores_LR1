...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🔍 Datos recibidos en LR1 Tree API route:', body)
    ...
    const apiUrl = 'https://9i7d8f10ih.execute-api.us-east-1.amazonaws.com/dev/lr1-tree'
    ...
    console.error('💥 Error en LR1 Tree API route:', error)
    return NextResponse.json(
      {
        success: false,
        error: 'Failed to fetch LR1 tree data',
